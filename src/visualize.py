    ...
    for q_idx in range(num_q):
        ...
        for g_idx in indices[q_idx,:]:
            ...
            if not invalid:
                ...
                if matched:
                    border_color = GREEN
                    #gimg = cv2.putText(gimg, '✔', (90, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.8, border_color, 2)
                    cv2.line(gimg, (98, 204), (112, 223),border_color, 3)
                    cv2.line(gimg, (112, 223), (136, 192),border_color, 3)
                else:
                    border_color = RED
                    cv2.line(gimg, (96, 188), (128, 223),border_color, 3)
                    cv2.line(gimg, (96, 223), (128, 188),border_color, 3)
                    #gimg = cv2.putText(gimg, '✘', (90, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.8, border_color, 2)
